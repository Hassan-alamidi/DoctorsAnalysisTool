...
public class PatientIntegrationTest extends BaseIntegrationTest{
    ...
    public void createNonExistingPatient(){
        Patient patient = Patient.builder()
                            ...
                            .build();
        ResponseEntity<Patient> createdPatient = restTemplate.postForEntity(BASE_ENDPOINT, patient, Patient.class);
        ...
        Assert.assertEquals(responseEntity.getBody().getAddress(),patient.getAddress());
    }
